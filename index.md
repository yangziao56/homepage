...
- **PTCT: Patches with 3D-Temporal Convolutional Transformer Network for Precipitation Nowcasting**
  ...
  **Ziao Yang**, Xiangrui Yang, Qifeng Lin
  <br>
  This paper was submitted to Thirty-sixth Conference on Neural Information Processing Systems. **NeurIPS 2022**, but the reviewers gave the following ratings: 5, 4, 3, 3, 3. Then, we submitted to IEEE/CVF Winter Conference on Applications of Computer Vision. **WACV 2023**
  <br>
